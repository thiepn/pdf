...
export function NativeComplexPropertiesPanel({ object, queued, onQueue, onRemove }: Props) {
  ...
  return <aside className="editor-properties native-unified-properties p7-complex-properties">
    <section className="property-section native-capability-card">
      <div className="native-capability-card__heading"><div><p className="eyebrow">Existing PDF content</p><h2>Nested PDF group</h2></div><span className={`capability-chip capability-chip--${object.capability.level}`}>{unsupported ? "Editing unavailable" : "Instance editing"}</span></div>
